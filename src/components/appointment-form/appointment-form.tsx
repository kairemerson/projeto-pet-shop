          ...
          {children && (
            ...
            <DialogContent variant="appointment" overlayVariant="blurred" showCloseButton>
                <DialogHeader>
                    ...
                    <DialogDescription size="modal">Preencha os dados do cliente para realizar um agendamento</DialogDescription>
                </DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <User className="absolute left-3 top-1/2 -translate-y-1/2 transform text-content-brand"/>
                      ...
                      <FormField control={form.control} name="petName" render={({field})=> (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <Dog className="absolute left-3 top-1/2 -translate-y-1/2 transform text-content-brand"/>
                              <Input placeholder="Nome do pet" className="pl-10" {...field}/>
                            </div>
                          </FormControl>
                          <FormMessage/>
                        </FormItem>
                      ...
                      <FormField control={form.control} name="phone" render={({field})=> (
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <Phone className="absolute left-3 top-1/2 -translate-y-1/2 transform text-content-brand"/>
                              <IMaskInput 
                      ...
                      <div className="space-y-4 md:grid grid-cols-2 gap-4 md:space-y-0">
