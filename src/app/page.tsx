...
export default async function Home({searchParams}: {searchParams: Promise<{date?: string}>}) {
  ...
  return (
    <div className="bg-background-primary p-6">
      ...
      <div className="fixed bottom-6 left-0 right-0 flex justify-center bg-[#23242C] py-[18px] px-6 md:botton-6 md:right-6 md:left-auto md:top-auto md:w-auto md:bg-transparent md:p-0">
        <AppointmentForm>
